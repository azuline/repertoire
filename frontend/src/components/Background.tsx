...
const innerBackgroundStyle = {
  background:
    'linear-gradient(190deg, rgba(16, 16, 19, 0.2), rgba(16, 16, 19, 0.5), rgba(16, 16, 19, 0.7), rgba(16, 16, 19, 1), rgba(16, 16, 19, 1))',
};
const outerBackgroundStyle = {
  background:
    'linear-gradient(200deg, rgba(16, 16, 19, 0), rgba(16, 16, 19, 0.0), rgba(16, 16, 19, 0.6), rgba(16, 16, 19, 0.8), rgba(16, 16, 19, 1), rgba(16, 16, 19, 1))',
};
