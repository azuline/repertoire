...
export type FetchArtistsQuery = { __typename?: 'Query' } & {
  artists?: Maybe<
    { __typename?: 'Artists' } & {
      results: Array<Maybe<{ __typename?: 'Artist' } & ArtistFieldsFragment>>;
    }
  >;
};
...
export type FetchArtistQuery = { __typename?: 'Query' } & {
  artist?: Maybe<{ __typename?: 'Artist' } & ArtistFieldsFragment>;
};
...
export type UpdateArtistMutation = { __typename?: 'Mutation' } & {
  updateArtist?: Maybe<{ __typename?: 'Artist' } & ArtistFieldsFragment>;
};
...
export type FetchCollectionsQuery = { __typename?: 'Query' } & {
  collections?: Maybe<
    { __typename?: 'Collections' } & {
      results: Array<Maybe<{ __typename?: 'Collection' } & CollectionFieldsFragment>>;
    }
  >;
};
...
export type FetchCollectionQuery = { __typename?: 'Query' } & {
  collection?: Maybe<{ __typename?: 'Collection' } & CollectionFieldsFragment>;
};
...
export type UpdateCollectionMutation = { __typename?: 'Mutation' } & {
  updateCollection?: Maybe<{ __typename?: 'Collection' } & CollectionFieldsFragment>;
};
...
export type AddReleaseToCollectionMutation = { __typename?: 'Mutation' } & {
  addReleaseToCollection?: Maybe<
    { __typename?: 'CollectionAndRelease' } & {
      collection: { __typename?: 'Collection' } & CollectionFieldsFragment;
      release: { __typename?: 'Release' } & ReleaseFieldsFragment;
    }
  >;
};
...
export type DelReleaseFromCollectionMutation = { __typename?: 'Mutation' } & {
...
export type UserFieldsFragment = { __typename?: 'User' } & Pick<User, 'id' | 'nickname'>;

export type ReleaseFieldsFragment = { __typename?: 'Release' } & Pick<
  Release,
  | 'id'
  | 'title'
  | 'releaseType'
...
export type ArtistFieldsFragment = { __typename?: 'Artist' } & Pick<
  Artist,
  'id' | 'name' | 'starred' | 'numReleases' | 'imageId'
>;

export type CollectionFieldsFragment = { __typename?: 'Collection' } & Pick<
  Collection,
  'id' | 'name' | 'starred' | 'type' | 'numReleases' | 'lastUpdatedOn' | 'imageId'
>;

export type TrackFieldsFragment = { __typename?: 'Track' } & Pick<
  Track,
  'id' | 'title' | 'duration' | 'trackNumber' | 'discNumber'
>;

export type FullReleaseFieldsFragment = { __typename?: 'Release' } & {
  artists: Array<Maybe<{ __typename?: 'Artist' } & Pick<Artist, 'id' | 'name'>>>;
  collages: Array<Maybe<{ __typename?: 'Collection' } & Pick<Collection, 'id' | 'name'>>>;
  labels: Array<Maybe<{ __typename?: 'Collection' } & Pick<Collection, 'id' | 'name'>>>;
  genres: Array<Maybe<{ __typename?: 'Collection' } & Pick<Collection, 'id' | 'name'>>>;
  tracks: Array<
    Maybe<
      { __typename?: 'Track' } & {
        release: { __typename?: 'Release' } & Pick<Release, 'id' | 'imageId'>;
        artists: Array<
          Maybe<
            { __typename?: 'TrackArtist' } & Pick<TrackArtist, 'role'> & {
                artist: { __typename?: 'Artist' } & Pick<Artist, 'id' | 'name'>;
              }
          >
        >;
      } & TrackFieldsFragment
...
export type FetchReleasesQuery = { __typename?: 'Query' } & {
  releases?: Maybe<
    { __typename?: 'Releases' } & Pick<Releases, 'total'> & {
        results: Array<
          Maybe<
            { __typename?: 'Release' } & {
              artists: Array<Maybe<{ __typename?: 'Artist' } & Pick<Artist, 'id' | 'name'>>>;
...
export type FetchReleasesRecentlyAddedQuery = { __typename?: 'Query' } & {
  releases?: Maybe<
    { __typename?: 'Releases' } & {
      results: Array<
        Maybe<
...
export type FetchReleaseQuery = { __typename?: 'Query' } & {
  release?: Maybe<{ __typename?: 'Release' } & FullReleaseFieldsFragment>;
};

export type FetchReleaseYearsQueryVariables = Exact<{ [key: string]: never }>;

export type FetchReleaseYearsQuery = { __typename?: 'Query' } & Pick<Query, 'releaseYears'>;
...
export type UpdateReleaseMutation = { __typename?: 'Mutation' } & {
  updateRelease?: Maybe<{ __typename?: 'Release' } & FullReleaseFieldsFragment>;
};
 ...
 * });
 */
export function useFetchArtistsQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchArtistsQuery, FetchArtistsQueryVariables>,
) {
  return Apollo.useQuery<FetchArtistsQuery, FetchArtistsQueryVariables>(
    FetchArtistsDocument,
    baseOptions,
  );
}
export function useFetchArtistsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchArtistsQuery, FetchArtistsQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchArtistsQuery, FetchArtistsQueryVariables>(
    FetchArtistsDocument,
    baseOptions,
  );
}
...
export type FetchArtistsQueryResult = Apollo.QueryResult<
  FetchArtistsQuery,
  FetchArtistsQueryVariables
>;
 ...
 * });
 */
export function useFetchArtistQuery(
  baseOptions: Apollo.QueryHookOptions<FetchArtistQuery, FetchArtistQueryVariables>,
) {
  return Apollo.useQuery<FetchArtistQuery, FetchArtistQueryVariables>(
    FetchArtistDocument,
    baseOptions,
  );
}
export function useFetchArtistLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchArtistQuery, FetchArtistQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchArtistQuery, FetchArtistQueryVariables>(
    FetchArtistDocument,
    baseOptions,
  );
}
...
export type FetchArtistQueryResult = Apollo.QueryResult<
  FetchArtistQuery,
  FetchArtistQueryVariables
>;
...
export function useUpdateArtistMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateArtistMutation, UpdateArtistMutationVariables>,
) {
  return Apollo.useMutation<UpdateArtistMutation, UpdateArtistMutationVariables>(
...
export function useFetchCollectionsQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchCollectionsQuery, FetchCollectionsQueryVariables>,
) {
  return Apollo.useQuery<FetchCollectionsQuery, FetchCollectionsQueryVariables>(
    FetchCollectionsDocument,
    baseOptions,
  );
}
export function useFetchCollectionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchCollectionsQuery, FetchCollectionsQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchCollectionsQuery, FetchCollectionsQueryVariables>(
    FetchCollectionsDocument,
    baseOptions,
  );
}
...
export type FetchCollectionsQueryResult = Apollo.QueryResult<
 ...
 * });
 */
export function useFetchCollectionQuery(
  baseOptions: Apollo.QueryHookOptions<FetchCollectionQuery, FetchCollectionQueryVariables>,
) {
  return Apollo.useQuery<FetchCollectionQuery, FetchCollectionQueryVariables>(
    FetchCollectionDocument,
    baseOptions,
  );
}
export function useFetchCollectionLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchCollectionQuery, FetchCollectionQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchCollectionQuery, FetchCollectionQueryVariables>(
    FetchCollectionDocument,
    baseOptions,
  );
}
...
export type FetchCollectionQueryResult = Apollo.QueryResult<
...
export const AddReleaseToCollectionDocument = gql`
  ...
  ${ReleaseFieldsFragmentDoc}
`;
export type AddReleaseToCollectionMutationFn = Apollo.MutationFunction<
  AddReleaseToCollectionMutation,
  AddReleaseToCollectionMutationVariables
>;
 ...
 * });
 */
export function useAddReleaseToCollectionMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AddReleaseToCollectionMutation,
    AddReleaseToCollectionMutationVariables
  >,
  ...
  return Apollo.useMutation<
    AddReleaseToCollectionMutation,
    AddReleaseToCollectionMutationVariables
  >(AddReleaseToCollectionDocument, baseOptions);
}
export type AddReleaseToCollectionMutationHookResult = ReturnType<
  typeof useAddReleaseToCollectionMutation
>;
export type AddReleaseToCollectionMutationResult = Apollo.MutationResult<AddReleaseToCollectionMutation>;
export type AddReleaseToCollectionMutationOptions = Apollo.BaseMutationOptions<
  AddReleaseToCollectionMutation,
  AddReleaseToCollectionMutationVariables
>;
export const DelReleaseFromCollectionDocument = gql`
  ...
  ${ReleaseFieldsFragmentDoc}
`;
export type DelReleaseFromCollectionMutationFn = Apollo.MutationFunction<
  DelReleaseFromCollectionMutation,
  DelReleaseFromCollectionMutationVariables
>;
 ...
 * });
 */
export function useDelReleaseFromCollectionMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DelReleaseFromCollectionMutation,
    DelReleaseFromCollectionMutationVariables
  >,
  ...
  return Apollo.useMutation<
    DelReleaseFromCollectionMutation,
    DelReleaseFromCollectionMutationVariables
  >(DelReleaseFromCollectionDocument, baseOptions);
}
export type DelReleaseFromCollectionMutationHookResult = ReturnType<
  typeof useDelReleaseFromCollectionMutation
>;
export type DelReleaseFromCollectionMutationResult = Apollo.MutationResult<DelReleaseFromCollectionMutation>;
export type DelReleaseFromCollectionMutationOptions = Apollo.BaseMutationOptions<
  DelReleaseFromCollectionMutation,
  DelReleaseFromCollectionMutationVariables
>;
 ...
 * });
 */
export function useFetchReleasesQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchReleasesQuery, FetchReleasesQueryVariables>,
) {
  return Apollo.useQuery<FetchReleasesQuery, FetchReleasesQueryVariables>(
    FetchReleasesDocument,
    baseOptions,
  );
}
export function useFetchReleasesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchReleasesQuery, FetchReleasesQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchReleasesQuery, FetchReleasesQueryVariables>(
    FetchReleasesDocument,
    baseOptions,
  );
}
...
export type FetchReleasesQueryResult = Apollo.QueryResult<
  FetchReleasesQuery,
  FetchReleasesQueryVariables
>;
 ...
 * });
 */
export function useFetchReleasesRecentlyAddedQuery(
  baseOptions?: Apollo.QueryHookOptions<
    FetchReleasesRecentlyAddedQuery,
    FetchReleasesRecentlyAddedQueryVariables
  >,
) {
  return Apollo.useQuery<FetchReleasesRecentlyAddedQuery, FetchReleasesRecentlyAddedQueryVariables>(
    FetchReleasesRecentlyAddedDocument,
    baseOptions,
  );
}
export function useFetchReleasesRecentlyAddedLazyQuery(
  ...
  return Apollo.useLazyQuery<
    FetchReleasesRecentlyAddedQuery,
    FetchReleasesRecentlyAddedQueryVariables
  >(FetchReleasesRecentlyAddedDocument, baseOptions);
}
export type FetchReleasesRecentlyAddedQueryHookResult = ReturnType<
  typeof useFetchReleasesRecentlyAddedQuery
>;
export type FetchReleasesRecentlyAddedLazyQueryHookResult = ReturnType<
  typeof useFetchReleasesRecentlyAddedLazyQuery
>;
export type FetchReleasesRecentlyAddedQueryResult = Apollo.QueryResult<
  FetchReleasesRecentlyAddedQuery,
  FetchReleasesRecentlyAddedQueryVariables
>;
 ...
 * });
 */
export function useFetchReleaseQuery(
  baseOptions: Apollo.QueryHookOptions<FetchReleaseQuery, FetchReleaseQueryVariables>,
) {
  return Apollo.useQuery<FetchReleaseQuery, FetchReleaseQueryVariables>(
    FetchReleaseDocument,
    baseOptions,
  );
}
export function useFetchReleaseLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchReleaseQuery, FetchReleaseQueryVariables>,
) {
  return Apollo.useLazyQuery<FetchReleaseQuery, FetchReleaseQueryVariables>(
    FetchReleaseDocument,
    baseOptions,
  );
}
...
export type FetchReleaseQueryResult = Apollo.QueryResult<
  FetchReleaseQuery,
  FetchReleaseQueryVariables
>;
 ...
 * });
 */
export function useFetchReleaseYearsQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchReleaseYearsQuery, FetchReleaseYearsQueryVariables>,
) {
  return Apollo.useQuery<FetchReleaseYearsQuery, FetchReleaseYearsQueryVariables>(
    FetchReleaseYearsDocument,
    baseOptions,
  );
}
export function useFetchReleaseYearsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FetchReleaseYearsQuery,
    FetchReleaseYearsQueryVariables
  >,
) {
  return Apollo.useLazyQuery<FetchReleaseYearsQuery, FetchReleaseYearsQueryVariables>(
    FetchReleaseYearsDocument,
    baseOptions,
  );
}
...
export type FetchReleaseYearsQueryResult = Apollo.QueryResult<
  FetchReleaseYearsQuery,
  FetchReleaseYearsQueryVariables
>;
export const UpdateReleaseDocument = gql`
  ...
  ${FullReleaseFieldsFragmentDoc}
`;
export type UpdateReleaseMutationFn = Apollo.MutationFunction<
...
export function useUpdateReleaseMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateReleaseMutation, UpdateReleaseMutationVariables>,
) {
  return Apollo.useMutation<UpdateReleaseMutation, UpdateReleaseMutationVariables>(
...
export type UpdateReleaseMutationOptions = Apollo.BaseMutationOptions<
  UpdateReleaseMutation,
  UpdateReleaseMutationVariables
>;
...
export type PlaylistKeySpecifier = (
  | 'id'
  | 'name'
  | 'starred'
  | 'type'
...
export type CollectionAndReleaseKeySpecifier = (
  | 'collection'
  | 'release'
  | CollectionAndReleaseKeySpecifier
)[];
...
export type TypedTypePolicies = TypePolicies & {
  ...
  CollectionAndRelease?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | CollectionAndReleaseKeySpecifier
      | (() => undefined | CollectionAndReleaseKeySpecifier);
    fields?: CollectionAndReleaseFieldPolicy;
  };
  PlaylistAndTrack?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PlaylistAndTrackKeySpecifier
      | (() => undefined | PlaylistAndTrackKeySpecifier);
    fields?: PlaylistAndTrackFieldPolicy;
  };
  ReleaseAndArtist?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ReleaseAndArtistKeySpecifier
      | (() => undefined | ReleaseAndArtistKeySpecifier);
