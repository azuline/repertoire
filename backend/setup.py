...
setup(
    ...
    package_data={"backend": ["migrations/*.sql"], "backend.graphql": ["*.graphql"]},
    ...
    extras_require={"dev": ["autodocsumm==0.1.13", "black==20.8b1", "flake8==3.*,>=3.8.0", "isort==5.*,>=5.4.0", "mypy==0.*,>=0.790.0", "pytest==6.*,>=6.1.1", "pytest-asyncio==0.*,>=0.14.0", "pytest-cov==2.*,>=2.10.1", "snapshottest==0.*,>=0.6.0", "sphinx==3.*,>=3.2.1", "sphinx-autodoc-typehints==1.*,>=1.11.1", "sphinx-js==3.*,>=3.1.0", "sphinx-rtd-theme==0.*,>=0.5.0", "sphinxcontrib.httpdomain==1.*,>=1.7.0"]},
)
