...
snapshots['test_releases 1'] = [
    GenericRepr("T(id=3, title='Departure', release_type=<ReleaseType.ALBUM: 1>, added_on=datetime.datetime(2020, 10, 19, 0, 25, 34), release_year=2016, release_date=None, image_path=PosixPath('/home/azul/devel/repertoire/data/cover_art/d832df509b44cb7c560e2579453178016c391cd2ab8d6eab3de2bbbdf75c4ac0.jpg'))")
]
