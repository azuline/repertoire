...
snapshots['test_add_artist 1'] = GenericRepr("T(id=2, title='We Don’t Have Each Other', release_type=<ReleaseType.ALBUM: 1>, added_on=FakeDatetime(2020, 10, 19, 0, 25, 34), release_year=2014, num_tracks=10, in_inbox=True, in_favorites=False, rating=6, runtime=2258, release_date=FakeDate(2014, 7, 8), image_id=1)")
...
snapshots['test_del_artist 1'] = GenericRepr("T(id=2, title='We Don’t Have Each Other', release_type=<ReleaseType.ALBUM: 1>, added_on=FakeDatetime(2020, 10, 19, 0, 25, 34), release_year=2014, num_tracks=10, in_inbox=True, in_favorites=False, rating=6, runtime=2258, release_date=FakeDate(2014, 7, 8), image_id=1)")
...
snapshots['test_release_from_id_success 1'] = GenericRepr("T(id=2, title='We Don’t Have Each Other', release_type=<ReleaseType.ALBUM: 1>, added_on=FakeDatetime(2020, 10, 19, 0, 25, 34), release_year=2014, num_tracks=10, in_inbox=True, in_favorites=False, rating=6, runtime=2258, release_date=FakeDate(2014, 7, 8), image_id=1)")
...
snapshots['test_search_all 1'] = [
    GenericRepr("T(id=1, title='Unknown Release', release_type=<ReleaseType.UNKNOWN: 12>, added_on=FakeDatetime(1970, 1, 1, 0, 0), release_year=None, num_tracks=0, in_inbox=False, in_favorites=False, rating=None, runtime=0, release_date=None, image_id=None)"),
...
snapshots['test_update_fields 1'] = GenericRepr("T(id=2, title='New Title', release_type=<ReleaseType.COMPILATION: 4>, added_on=FakeDatetime(2020, 10, 19, 0, 25, 34), release_year=2040, num_tracks=10, in_inbox=True, in_favorites=False, rating=1, runtime=2258, release_date=FakeDate(2040, 10, 28), image_id=1)")
