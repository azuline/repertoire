...
snapshots['test_release_search_all 1'] = (
    3,
    [
        GenericRepr("T(id=1, title='Unknown Release', release_type=<ReleaseType.UNKNOWN: 12>, added_on=datetime.datetime(1970, 1, 1, 0, 0), release_year=0, num_tracks=0, in_inbox=False, runtime=0, release_date=None, image_path=None)"),
        GenericRepr("T(id=2, title='We Don’t Have Each Other', release_type=<ReleaseType.ALBUM: 1>, added_on=datetime.datetime(2020, 10, 19, 0, 25, 34), release_year=2014, num_tracks=10, in_inbox=True, runtime=2258, release_date=datetime.date(2014, 7, 8), image_path=PosixPath('/data/cover_art/fb21f22d84bb812bb8bd1988ee89c3a91f1d41e92cf988ef774423e9d85e3292.jpg'))"),
...
snapshots['test_update_fields 1'] = GenericRepr("T(id=2, title='New Title', release_type=<ReleaseType.COMPILATION: 4>, added_on=datetime.datetime(2020, 10, 19, 0, 25, 34), release_year=2040, num_tracks=10, in_inbox=True, runtime=2258, release_date=datetime.date(2040, 10, 28), image_path=PosixPath('/data/cover_art/fb21f22d84bb812bb8bd1988ee89c3a91f1d41e92cf988ef774423e9d85e3292.jpg'))")
