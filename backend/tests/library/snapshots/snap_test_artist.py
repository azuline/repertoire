...
snapshots['test_top_genres 1'] = [
    ...
    {
        'genre': GenericRepr("T(id=4, name='Rock', starred=False, type=<CollectionType.GENRE: 4>, num_releases=None, last_updated_on=FakeDatetime(2020, 10, 19, 0, 25, 34))"),
        'num_matches': 1
    },
    {
        'genre': GenericRepr("T(id=5, name='Country', starred=False, type=<CollectionType.GENRE: 4>, num_releases=None, last_updated_on=FakeDatetime(2020, 10, 19, 0, 25, 34))"),
        'num_matches': 1
    },
    {
        'genre': GenericRepr("T(id=6, name='World', starred=False, type=<CollectionType.GENRE: 4>, num_releases=None, last_updated_on=FakeDatetime(2020, 10, 19, 0, 25, 34))"),
        'num_matches': 1
    }
]
