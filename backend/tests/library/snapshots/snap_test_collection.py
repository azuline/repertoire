...
snapshots['test_add_release 1'] = GenericRepr("T(id=2, name='Favorites', starred=True, type=<CollectionType.SYSTEM: 1>, num_releases=1, last_updated_on=None)")
...
snapshots['test_all 1'] = [
    GenericRepr("T(id=2, name='Favorites', starred=True, type=<CollectionType.SYSTEM: 1>, num_releases=0, last_updated_on=None)"),
    ...
    GenericRepr("T(id=11, name='MyLabel', starred=False, type=<CollectionType.LABEL: 3>, num_releases=0, last_updated_on=None)"),
    GenericRepr("T(id=10, name='Ambient', starred=False, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))"),
    ...
    GenericRepr("T(id=7, name='Downtempo', starred=False, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))"),
    GenericRepr("T(id=8, name='Electronic', starred=False, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))"),
    ...
    GenericRepr("T(id=9, name='House', starred=False, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))"),
...
snapshots['test_del_release 1'] = GenericRepr("T(id=3, name='Folk', starred=False, type=<CollectionType.GENRE: 4>, num_releases=0, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))")

snapshots['test_del_release 2'] = [
]

snapshots['test_from_id_success 1'] = GenericRepr("T(id=7, name='Downtempo', starred=False, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))")
...
snapshots['test_update_fields 1'] = GenericRepr("T(id=4, name='New Name', starred=True, type=<CollectionType.GENRE: 4>, num_releases=1, last_updated_on=datetime.datetime(2020, 10, 19, 0, 25, 34))")
